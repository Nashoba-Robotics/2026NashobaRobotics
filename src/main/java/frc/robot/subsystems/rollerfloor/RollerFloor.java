...
public class RollerFloor extends SubsystemBase {
  ...
  private final Debouncer followerMotorConnectedDebouncer = new Debouncer(0.5, DebounceType.kFalling);
  ...
  public void periodic() {
    ...
    leaderRollerFloorMotorDisconnectedAlert.set(!leaderMotorConnectedDebouncer.calculate(inputs.leaderConnected));
    followerRollerFloorMotorDisconnectedAlert.set(!followerMotorConnectedDebouncer.calculate(inputs.followerConnected));
  }
