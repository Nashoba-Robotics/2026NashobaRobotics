...
public class ClimberIOTalonFX implements ClimberIO {
    ...
    public ClimberIOTalonFX(){
        ...
        config.SoftwareLimitSwitch.ForwardSoftLimitThreshold = Constants.Climber.FORWARD_SOFT_LIMIT.getRotations();
        config.SoftwareLimitSwitch.ReverseSoftLimitEnable = true;
        config.SoftwareLimitSwitch.ReverseSoftLimitThreshold = Constants.Climber.REVERSE_SOFT_LIMIT.getRotations();
        ...
        encoderConfig.MagnetSensor.AbsoluteSensorDiscontinuityPoint = Constants.Climber.ENCODER_DISCONTINUITY_POINT;
    ...
    public void updateInputs(ClimberIOInputs inputs) {
        ...
        inputs.absolutePositionRads = Units.rotationsToRadians(encoder.getPosition().getValueAsDouble());
