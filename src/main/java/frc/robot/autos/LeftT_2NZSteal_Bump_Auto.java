...
public class LeftT_2NZSteal_Bump_Auto extends AutoModeBase {
  public LeftT_2NZSteal_Bump_Auto(Drive drive, Superstructure superstructure, AutoFactory factory) {
    super(factory, "Left Steal DoubleSweep Bump");

    AutoTrajectory left_T_NZSteal_B = trajectory("Left_T_NZSteal_B");
    AutoTrajectory left_Safe_Bump = trajectory("Left_Safe_Bump");
    AutoTrajectory left_2nd_T_NZ_B = trajectory("Left_2nd_T_NZ_B");
    newRoutine(
        left_T_NZSteal_B.resetOdometry(),
        new ParallelDeadlineGroup(
                cmdWithAccuracy(
                    drive, left_T_NZSteal_B, Units.Seconds.of(20.0), Units.Centimeters.of(25.0)),
