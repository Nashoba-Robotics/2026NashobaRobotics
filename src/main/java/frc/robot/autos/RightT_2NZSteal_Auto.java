...
public class RightT_2NZSteal_Auto extends AutoModeBase {
  public RightT_2NZSteal_Auto(Drive drive, Superstructure superstructure, AutoFactory factory) {
    super(factory, "RightT_2NZSteal_Auto");

    AutoTrajectory right_T_NZSteal = trajectory("Right_T_NZSteal");
